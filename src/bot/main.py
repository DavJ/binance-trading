...
exchangeModule = importlib.import_module('src.bot.exchanges.' + exchange_name, package=None)
exchangeClass = getattr(exchangeModule, get_java_name(exchange_name))
...
# Load strategy
strategyModule = importlib.import_module('src.bot.strategies.' + strategy, package=None)
